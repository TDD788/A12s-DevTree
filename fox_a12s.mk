...
LC_ALL := C
export ALLOW_MISSING_DEPENDENCIES LC_ALL
...
FOX_VARIANT := AOSP
export OF_MAINTAINER FOX_BUILD_TYPE FOX_VERSION FOX_VARIANT
...
export FOX_CUSTOM_BINS_TO_SDCARD FOX_USE_NANO_EDITOR FOX_USE_SED_BINARY FOX_USE_TAR_BINARY FOX_USE_UNZIP_BINARY FOX_USE_XZ_UTILS FOX_USE_ZSTD_BINARY
...
export FOX_TARGET_DEVICES TARGET_DEVICE_ALT FOX_BUILD_DEVICE
...
define export_build_vars
    ...
    export FOX_DELETE_AROMAFM OF_CHECK_OVERWRITE_ATTEMPTS OF_WIPE_METADATA_AFTER_DATAFORMAT FOX_DELETE_INITD_ADDON FOX_ENABLE_APP_MANAGER OF_USE_SAMSUNG_HAPTICS OF_USE_TWRP_SAR_DETECT OF_QUICK_BACKUP_LIST OF_USE_SYSTEM_FINGERPRINT FOX_USE_SPECIFIC_MAGISK_ZIP

    # Security configurations
    OF_ADVANCED_SECURITY := 1
    export OF_ADVANCED_SECURITY
    ...
    OF_CLOCK_POS := 1
    export OF_STATUS_INDENT_RIGHT OF_STATUS_INDENT_LEFT OF_STATUS_H OF_SCREEN_H OF_OPTIONS_LIST_NUM OF_CLOCK_POS
    ...
    export OF_USE_LZMA_COMPRESSION OF_ENABLE_FS_COMPRESSION FOX_RECOVERY_INSTALL_PARTITION FOX_RECOVERY_VENDOR_PARTITION FOX_RECOVERY_SYSTEM_PARTITION
    ...
    export OF_NO_TREBLE_COMPATIBILITY_CHECK OF_IGNORE_LOGICAL_MOUNT_ERRORS OF_USE_HEXDUMP OF_ENABLE_LPTOOLS FOX_NO_SAMSUNG_SPECIAL OF_PATCH_AVB20 OF_SUPPORT_VBMETA_AVB2_PATCHING OF_NO_SPLASH_CHANGE

    # Flashlight paths configurations
    OF_FL_PATH1 := /system/flashlight
    OF_FL_PATH2 := 
    OF_FLASHLIGHT_ENABLE := 1
    export OF_FL_PATH1 OF_FL_PATH2 OF_FLASHLIGHT_ENABLE
